...
function Login() {
    ...
    const submitHandler = (e)=>{
        ...
        localStorage.setItem('sush',enteredemail)
        fetch('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBSRlYdH1OVy1HQ2gJd455ndQS3ip8QNts',{
            method:'POST',
            body:JSON.stringify({
                email:enteredemail,
