...
import { Col, Button, Row, Container, Card, Form, NavLink } from 'react-bootstrap';
...
export default function SignUP() {
  ...
  const submithandler = (e)=>{
     ...
     fetch('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBi7f_GcJULnC9VuLvnLzSDkuY9gsLHKyw',{
        method:'POST',
        body:JSON.stringify({
            email:enteredemail,
                  ...
                  <div className="mb-3">
                    <Form onSubmit={submithandler}>
                      ...
                      >
                        ...
                        <Form.Control type="password" placeholder="Password" ref = {passwardref} />
                      </Form.Group>
                      <Form.Group
                        className="mb-3"
                        controlId="formBasicPassword"
